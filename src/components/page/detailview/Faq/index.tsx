  ...
  const faqList = [
    {
      ...
      text: (
        <p>
          <strong>독서모임</strong> 월 1회, 총 4번의 컬쳐플레이스 독서모임에
          참여하게 됩니다. (일부 6회)
          <br />
          <strong>이벤트</strong> 강연부터 체험까지 지적이고 사랑스러운 이벤트에
          참여하실 수 있어요.
          <br />
          <strong>아지트</strong> 컬쳐플레이스 멤버가 모여 읽고, 쓰고, 대화하고
          놀 수 있는 공간이 제공돼요.
          <br />
          <Link href="/">
    ...
    },
    {
      ...
      text: (
        <p>
          안타깝지만 그렇습니다!
          <br />
          컬쳐플레이스는 참가자 모두 책을 읽고 각자의 생각을 정리한 후 양질의
          대화가 이루어진다고 믿습니다. 저희를 믿고 등록을 해주신 멤버
          여러분들에게 &apos;지속 가능한 독서모임 서비스&apos;를 제공하기
          위해서라도, 저희는 최선을 다해 원칙을 지켜나가려고 합니다.
          <br />
          예쁘게 봐주세요!
        </p>
      )
